...
---
 ...
 - [測地成果2024とは(Gemini、一部修正)](#測地成果2024とはgemini一部修正)
   - [1. 何が変わったのか？](#1-何が変わったのか)
   - [2. なぜ改定されたのか？](#2-なぜ改定されたのか)
   - [3. 私たちの生活や業務への影響](#3-私たちの生活や業務への影響)
   - [補足：名称の整理](#補足名称の整理)
 - [JGD2011からJGD2024への標高補正方法](#jgd2011からjgd2024への標高補正方法)
   - [標高変換ツール(JGD2011からJGD2024)](#標高変換ツールjgd2011からjgd2024)
     - [Web版PatchJGD(標高版)](#web版patchjgd標高版)
     - [ソフトウェアPatchJGD\_HV](#ソフトウェアpatchjgd_hv)
   - [標高補正パラメータファイル](#標高補正パラメータファイル)
 - [標高補正の河川縦断形への影響](#標高補正の河川縦断形への影響)
   - [サンプルデータ](#サンプルデータ)
   - [Web版PatchJGD(標高版)による変換](#web版patchjgd標高版による変換)
   - [ソフトウェアPatchJGD\_HVによる変換](#ソフトウェアpatchjgd_hvによる変換)
   - [標高補正の河川縦断形への影響評価](#標高補正の河川縦断形への影響評価)
 - [補足：標高補正プログラムの作成（Python、暫定版）](#補足標高補正プログラムの作成python暫定版)
   - [パラメータファイルをメッシュコードから緯度経度に変換](#パラメータファイルをメッシュコードから緯度経度に変換)
   - [補正量を計算](#補正量を計算)
